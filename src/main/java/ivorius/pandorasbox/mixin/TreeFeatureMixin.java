...
public abstract class TreeFeatureMixin implements TreeFeatureExtensions<TreeConfiguration> {
    @Shadow
    ...
    @Override
    public boolean pandorasBox$placeWithBlockOverrides(FeaturePlaceContext<TreeConfiguration> featurePlaceContext, BlockState trunk, BlockState leaves) {
        ...
        BiConsumer<BlockPos, BlockState> biConsumer2 = (blockPosx, blockState) -> {
            ...
            worldGenLevel.setBlock(blockPosx, trunk, 19);
        };
