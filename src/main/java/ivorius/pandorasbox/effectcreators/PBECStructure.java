    ...
    public PBEffect constructEffect(Level world, double x, double y, double z, RandomSource random) {
        ...
        if (world instanceof ServerLevel serverLevel) {
            ...
            while (!tempStructures.isEmpty()) {
                ...
                StructureStart structureStart = structure.structure().value().generate(structure.structure(),
                        world.dimension(),
                        ...
                        ChunkPos.rangeClosed(minChunk, maxChunk)
                                .forEach(
                                        inChunk -> structureStart.placeInChunk(
                                                ...
                                                generator,
                                                random,
                                                new BoundingBox(inChunk.getMinBlockX(), serverLevel.getMinY(), inChunk.getMinBlockZ(), inChunk.getMaxBlockX(), serverLevel.getMaxY(), inChunk.getMaxBlockZ()),
                                                inChunk
                                        )
                                );
                        break;
