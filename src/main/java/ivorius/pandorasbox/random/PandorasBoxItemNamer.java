...
{
    public static String[] prefixesB = new String[]{"The", "The one and only", "Our", "Everyone's", "Woodcutter's", "Notch's", "Miner's", "Steve's", "Creeper's", "A", "Similar to the", "Your", "A copy of the", "New clone of", "Born from the"};
    public static String[] prefixes = new String[]{"Ominous", "Cataclysmic", "Amiable", "Introspective", "Creepy", "Awesome", "Odd", "Stinking", "Uncontrollable", "Controllable", "Catastrophical", "Talking", "Silent", "Furious", "Banned", "Illegal", "Vast", "Huge", "Tiny", "Holographic", "Metaphorical", "#l~^", "Secret", "Unknown", "Popular", "Seecret", "Ivorius's", "Overrated", "Underrated", "Forgotten", "Lost", "Epic", "Heroic", "Famous", "Colossal", "Stupidly Strong", "Heroic", "Mad", "Wise", "Uncontrollable", "Glorious", "Shiny", "Unprecedented", "Unbelievable", "Incredible", "Problematic", "Distinct", "Lesser", "Greater", "Striking", "Impossible", "Possible", "Colorful", "Illusive", "Omnipresent"};

    public static String[] mainNames = new String[]{"Tool", "Eye", "Board", "Weapon", "Toy", "Memory", "Relic", "Orb", "Block", "Thingy", "Device", "Killer", "Eraser", "Diminisher", "Supporter", "Spreader", "Eater", "Devourer", "XXa=})", "Helper", "Teacher", "Inventor", "Partner", "Friday", "Catapult", "Peak", "Player", "Remedy", "Destination", "Constructor", "Prophet", "Bomb", "Oracle", "Calculator", "Ally"};

    public static String[] suffixes = new String[]{"of Blasphemy", "of Destruction", "of Happy Fun Times", "of Anger", "of Ultimate Evil", "of Gold", "of Wealth", "of Nyan", "of Lords and Knights", "of Water", "of Fire", "of Notch", "of Mojang", "of Light", "of Empty Fridges", "of Cold", "of Icecream", "of Cold Blooded Murder", "of Secret Organizations", "of Computers", "of 4th Wall Breaking", "#_::/", "of Electricity", "of Alien Technology", "of Political Correctness", "with a Twist", "of Teasing Grammer Nazis", "of Updates", "with 3 heads", "of manleyness", "that has a far too long name, greatly to the dismay of the viewing player", "- deal with it", "of Luck", "of Grandiose... Something", "- Courtesy of Atlas Development", "of Yearly Updates", "of Nonsensical Monologues", "of a Silly Amount", "of Backflips"};
