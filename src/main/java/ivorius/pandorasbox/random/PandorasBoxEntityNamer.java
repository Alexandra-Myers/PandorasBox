...
public class PandorasBoxEntityNamer
{
    ...
    public static String[] mainNames = new String[]{"Dinnerbone", "Grumm", "jeb_", "Killer", "Savior", "Lord", "King", "Champion", "Bum", "Friend", "Enemy", "Soldier", "Captain", "Thing", "Prophet", "Guide", "Knight", "Leader", "Despot", "Machine", "Droid", "Shapeshifter", "Boss", "Weirdo", "Outcast"};
