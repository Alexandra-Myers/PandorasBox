...
public class ComponentInit {
    ...
    private static <T> DataComponentType<T> register(String name, UnaryOperator<DataComponentType.Builder<T>> unaryOperator) {
        return Registry.register(BuiltInRegistries.DATA_COMPONENT_TYPE, ResourceKey.create(Registries.DATA_COMPONENT_TYPE, Identifier.fromNamespaceAndPath(PandorasBox.MOD_ID, name)), unaryOperator.apply(DataComponentType.builder()).build());
    }
