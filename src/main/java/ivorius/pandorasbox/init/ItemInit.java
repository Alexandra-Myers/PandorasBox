...
public class ItemInit {
    public static final PandorasBoxItem PBI = register("pandoras_box", (key) -> new PandorasBoxItem(PB, new Item.Properties().component(ComponentInit.EFFECT_COMPONENT, PBEffectComponent.DEFAULT).component(DataComponents.TOOLTIP_DISPLAY, TooltipDisplay.DEFAULT.withHidden(ComponentInit.EFFECT_COMPONENT, true)).setId(key)));
