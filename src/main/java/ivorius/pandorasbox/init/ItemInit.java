...
public class ItemInit {
    public static final PandorasBoxItem PBI = register("pandoras_box", new PandorasBoxItem(PB, new Item.Properties().component(ComponentInit.EFFECT_COMPONENT, PBEffectComponent.DEFAULT)));
