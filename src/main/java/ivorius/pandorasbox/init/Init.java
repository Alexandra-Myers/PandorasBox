...
public class Init {
    ...
    public static final Registry<MapCodec<? extends PBEffect>> BOX_EFFECT_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(BOX_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation("duplicate_box")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends EntityEffect>> ENTITY_EFFECT_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(ENTITY_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "bomberman")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends PositionEffect>> POSITION_EFFECT_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(POSITION_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "random_explosions")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends SpawnEntitiesEffect>> SPAWN_ENTITIES_EFFECT_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(SPAWN_ENTITIES_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "spawn_entities_id_list")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends GenerateByFlag>> GEN_FLAGS_EFFECT_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(GEN_FLAGS_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "gen_cover")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends Generate2D>> GEN_2D_EFFECT_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(GEN_2D_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "gen_dome")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends GenerateEffect>> GENERATE_EFFECT_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(GENERATE_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "gen_convert")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends BlockMapper>> BLOCK_MAPPER_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(BLOCK_MAPPER_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "convert_simple")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends EntitySpawner>> ENTITY_SPAWNER_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(ENTITY_SPAWNER_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "spawn_random")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends FeatureGenerator>> FEATURE_GENERATOR_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(FEATURE_GENERATOR_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "generate_feature")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends GenerateEffectCreator>> GENERATE_EFFECT_CREATOR_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(GENERATE_EFFECT_CREATOR_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "prepare_gen_convert")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends BlockMapperCreator>> BLOCK_MAPPER_CREATOR_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(BLOCK_MAPPER_CREATOR_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "direct")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends FeatureGeneratorCreator>> FEATURE_GENERATOR_CREATOR_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(FEATURE_GENERATOR_CREATOR_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "direct")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends PBEffectCreator>> BOX_EFFECT_CREATOR_REGISTRY = FabricRegistryBuilder.createDefaulted(BOX_EFFECT_CREATOR_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, "duplicate_box")).attribute(RegistryAttribute.SYNCED).buildAndRegister();

    public static MapCodec<? extends PBEffect> registerBoxEffectType(MapCodec<? extends PBEffect> mapCodec, String name) {
        return Registry.register(BOX_EFFECT_TYPE_REGISTRY, ResourceKey.create(BOX_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(name)), mapCodec);
    }
    public static MapCodec<? extends EntityEffect> registerEntityEffectType(MapCodec<? extends EntityEffect> mapCodec, String name) {
        return Registry.register(ENTITY_EFFECT_TYPE_REGISTRY, ResourceKey.create(ENTITY_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, name)), mapCodec);
    }
    public static MapCodec<? extends PositionEffect> registerPositionEffectType(MapCodec<? extends PositionEffect> mapCodec, String name) {
        return Registry.register(POSITION_EFFECT_TYPE_REGISTRY, ResourceKey.create(POSITION_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, name)), mapCodec);
    }
    public static MapCodec<? extends SpawnEntitiesEffect> registerSpawnEntitiesEffectType(MapCodec<? extends SpawnEntitiesEffect> mapCodec, String name) {
        return Registry.register(SPAWN_ENTITIES_EFFECT_TYPE_REGISTRY, ResourceKey.create(SPAWN_ENTITIES_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, name)), mapCodec);
    }
    public static MapCodec<? extends GenerateByFlag> registerGenFlagsEffectType(MapCodec<? extends GenerateByFlag> mapCodec, String name) {
        return Registry.register(GEN_FLAGS_EFFECT_TYPE_REGISTRY, ResourceKey.create(GEN_FLAGS_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, name)), mapCodec);
    }
    public static MapCodec<? extends Generate2D> registerGenTwoDimensionalEffectType(MapCodec<? extends Generate2D> mapCodec, String name) {
        return Registry.register(GEN_2D_EFFECT_TYPE_REGISTRY, ResourceKey.create(GEN_2D_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, name)), mapCodec);
    }
    public static MapCodec<? extends GenerateEffect> registerGenerateEffectType(MapCodec<? extends GenerateEffect> mapCodec, String name) {
        return Registry.register(GENERATE_EFFECT_TYPE_REGISTRY, ResourceKey.create(GENERATE_EFFECT_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, name)), mapCodec);
    }
    public static MapCodec<? extends BlockMapper> registerBlockMapperType(MapCodec<? extends BlockMapper> mapCodec, String name) {
        return Registry.register(BLOCK_MAPPER_TYPE_REGISTRY, ResourceKey.create(BLOCK_MAPPER_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, name)), mapCodec);
    }
    public static MapCodec<? extends EntitySpawner> registerEntitySpawnerType(MapCodec<? extends EntitySpawner> mapCodec, String name) {
        return Registry.register(ENTITY_SPAWNER_TYPE_REGISTRY, ResourceKey.create(ENTITY_SPAWNER_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, name)), mapCodec);
    }
    public static MapCodec<? extends FeatureGenerator> registerFeatureGeneratorType(MapCodec<? extends FeatureGenerator> mapCodec, String name) {
        return Registry.register(FEATURE_GENERATOR_TYPE_REGISTRY, ResourceKey.create(FEATURE_GENERATOR_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, name)), mapCodec);
    }
    public static MapCodec<? extends GenerateEffectCreator> registerGenerateEffectCreatorType(MapCodec<? extends GenerateEffectCreator> mapCodec, String name) {
        return Registry.register(GENERATE_EFFECT_CREATOR_TYPE_REGISTRY, ResourceKey.create(GENERATE_EFFECT_CREATOR_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, name)), mapCodec);
    }
    public static MapCodec<? extends BlockMapperCreator> registerBlockMapperCreatorType(MapCodec<? extends BlockMapperCreator> mapCodec, String name) {
        return Registry.register(BLOCK_MAPPER_CREATOR_TYPE_REGISTRY, ResourceKey.create(BLOCK_MAPPER_CREATOR_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, name)), mapCodec);
    }
    public static MapCodec<? extends FeatureGeneratorCreator> registerFeatureGeneratorCreatorType(MapCodec<? extends FeatureGeneratorCreator> mapCodec, String name) {
        return Registry.register(FEATURE_GENERATOR_CREATOR_TYPE_REGISTRY, ResourceKey.create(FEATURE_GENERATOR_CREATOR_TYPE_REGISTRY_KEY, new ResourceLocation(PandorasBox.MOD_ID, name)), mapCodec);
    }
