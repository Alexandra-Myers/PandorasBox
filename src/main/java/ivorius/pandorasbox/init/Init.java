...
public class Init {
    ...
    public static final ResourceKey<Registry<PBEffect.PBEffectType<? extends PBEffect>>> BOX_EFFECT_TYPE_REGISTRY_KEY = ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(PandorasBox.MOD_ID, "pandora_effects"));
    public static final Registry<PBEffect.PBEffectType<? extends PBEffect>> BOX_EFFECT_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(BOX_EFFECT_TYPE_REGISTRY_KEY, Identifier.withDefaultNamespace("duplicate_box")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
