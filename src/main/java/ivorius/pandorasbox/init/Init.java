...
public class Init {
    ...
    public static final Registry<MapCodec<? extends GenerateByFlagCreator>> GEN_FLAGS_EFFECT_CREATOR_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(GEN_FLAGS_EFFECT_CREATOR_TYPE_REGISTRY_KEY, Identifier.fromNamespaceAndPath(PandorasBox.MOD_ID, "direct")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final Registry<MapCodec<? extends Generate2DCreator>> GEN_2D_EFFECT_CREATOR_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(GEN_2D_EFFECT_CREATOR_TYPE_REGISTRY_KEY, Identifier.fromNamespaceAndPath(PandorasBox.MOD_ID, "direct")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static final ResourceKey<Registry<MapCodec<? extends BlockMapperCreator>>> BLOCK_MAPPER_CREATOR_TYPE_REGISTRY_KEY = ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(PandorasBox.MOD_ID, "modify_blocks_creators"));
    public static final Registry<MapCodec<? extends BlockMapperCreator>> BLOCK_MAPPER_CREATOR_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(BLOCK_MAPPER_CREATOR_TYPE_REGISTRY_KEY, Identifier.fromNamespaceAndPath(PandorasBox.MOD_ID, "direct")).attribute(RegistryAttribute.SYNCED).buildAndRegister();

    public static final ResourceKey<Registry<MapCodec<? extends FeatureGeneratorCreator>>> FEATURE_GENERATOR_CREATOR_TYPE_REGISTRY_KEY = ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(PandorasBox.MOD_ID, "feature_generators_convert_creators"));
    public static final Registry<MapCodec<? extends FeatureGeneratorCreator>> FEATURE_GENERATOR_CREATOR_TYPE_REGISTRY = FabricRegistryBuilder.createDefaulted(FEATURE_GENERATOR_CREATOR_TYPE_REGISTRY_KEY, Identifier.fromNamespaceAndPath(PandorasBox.MOD_ID, "direct")).attribute(RegistryAttribute.SYNCED).buildAndRegister();
    ...
    public static MapCodec<? extends BlockMapperCreator> registerBlockMapperCreatorType(MapCodec<? extends BlockMapperCreator> mapCodec, String name) {
        return Registry.register(BLOCK_MAPPER_CREATOR_TYPE_REGISTRY, ResourceKey.create(BLOCK_MAPPER_CREATOR_TYPE_REGISTRY_KEY, Identifier.fromNamespaceAndPath(PandorasBox.MOD_ID, name)), mapCodec);
    }
    public static MapCodec<? extends FeatureGeneratorCreator> registerFeatureGeneratorCreatorType(MapCodec<? extends FeatureGeneratorCreator> mapCodec, String name) {
        return Registry.register(FEATURE_GENERATOR_CREATOR_TYPE_REGISTRY, ResourceKey.create(FEATURE_GENERATOR_CREATOR_TYPE_REGISTRY_KEY, Identifier.fromNamespaceAndPath(PandorasBox.MOD_ID, name)), mapCodec);
    }
