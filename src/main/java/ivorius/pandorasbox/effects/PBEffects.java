...
public class PBEffects {
    ...
    public static void registerEffectCreators() {
        ...
        addAllToMeltdown(new PBECSpawnBlocks(new ILinear(10, 40), new ILinear(3, 5), new ZConstant(true), PandorasBoxHelper.blocks, Optional.empty(), Optional.of(PBECSpawnBlocks.defaultShowerSpawn())),
                ...
                PBECMulti.create(new PBECSpawnEnchantedItems(new IConstant(1), new ILinear(2, 15), new IExp(10, 50, 10.0), PandorasBoxHelper.enchantableArmorList, new ZChance(0.8), new ZConstant(true)), 0, new PBECSpawnEnchantedItems(new IConstant(1), new ILinear(2, 15), new IExp(10, 50, 10.0), PandorasBoxHelper.enchantableToolList, new ZChance(0.8), new ZConstant(true)), 0),
