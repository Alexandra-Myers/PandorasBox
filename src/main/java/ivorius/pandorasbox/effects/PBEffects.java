...
public class PBEffects {
    ...
    public static void registerEffectCreators() {
        ...
        addAllToMeltdown(new PBECSpawnBlocks(new ILinear(10, 40), new ILinear(3, 5), PandorasBoxHelper.blocks, null, PBECSpawnBlocks.defaultShowerSpawn()),
                ...
                new PBECMulti(new PBECConvertToHomo(new DLinear(10.0, 15.0)), 10, new PBECSpawnArmy(new ILinear(1, 4), new IConstant(0), PandorasBoxHelper.creatures), 0),
        ...
        PBECRegistry.register(new PBECSpawnItems(new ILinear(1, 3), new ILinear(0, 30), PandorasBoxHelper.items, new ZConstant(true)), "is_this_edible");
