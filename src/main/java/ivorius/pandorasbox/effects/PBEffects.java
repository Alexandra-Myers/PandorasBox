...
//        PBECRegistry.register(new PBECRuinedPortal(new ILinear(5, 15), new ILinear(5, 10), new ILinear(5, 15), new ILinear(2, 5), blockArrayList, loot, Direction.Axis.Z), "gatewayToHellZ", false);
        ...
        PBECRegistry.register(new PBECBuffEntities(new ILinear(20 * 3, 20 * 6), new IConstant(1), new DLinear(8.0, 25.0), 0.95f, Arrays.asList(new WeightedPotion(100, Effects.MOVEMENT_SLOWDOWN, 4, 8, 20 * 6, 20 * 20))), "frozenInPlace", false);
        ...
        PBECRegistry.register(new PBECSpawnEnchantedItems(new ILinear(1, 4), new ILinear(0, 30), new IExp(1, 30, 10.0), Arrays.asList(new RandomizedItemStack(Items.ENCHANTED_BOOK, 1, 1, 100)), new ZChance(0.1)), "enchantedBook", true);
        ...
        PBECRegistry.register(new PBECMulti(new PBECConvertToHeavenly(new DLinear(20.0, 80.0)), 0, new PBECRandomShapes(new DLinear(20.0, 80.0), new DLinear(2, 5), new ILinear(8, 10), Arrays.asList(new WeightedBlock(1, Blocks.COBWEB)), new ZConstant(true)), 0), "heavenly", true);
