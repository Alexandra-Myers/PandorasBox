...
//        PBECRegistry.register(new PBECRuinedPortal(new ILinear(5, 15), new ILinear(5, 10), new ILinear(5, 15), new ILinear(2, 5), blockArrayList, loot, Direction.Axis.Z), "gatewayToHellZ", false);
        ...
        PBECRegistry.register(new PBECBuffEntities(new ILinear(20 * 3, 20 * 6), new IConstant(1), new DLinear(8.0, 25.0), 0.95f, Arrays.asList(new WeightedPotion(100, MobEffects.MOVEMENT_SLOWDOWN, 4, 8, 20 * 6, 20 * 20))), "frozenInPlace", false);
