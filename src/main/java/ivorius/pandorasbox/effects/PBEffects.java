...
public class PBEffects
{
    public static void registerEffectCreators()
    {
        ...
        PBECRegistry.register(new PBECReplace(new DLinear(40.0, 120.0), new Block[]{Blocks.WATER, Blocks.LAVA}, Collections.singletonList(new WeightedBlock(100, Blocks.AIR)), new ZConstant(false)), "dryness", false);
...
//        PBECRegistry.register(new PBECRuinedPortal(new ILinear(5, 15), new ILinear(5, 10), new ILinear(5, 15), new ILinear(2, 5), blockArrayList, loot, Direction.Axis.Z), "gatewayToHellZ", false);
        ...
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(20, 200), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), Collections.singletonList(new WeightedEntity(100, "arrow", 1, 1)), new ValueThrow(new DLinear(0.05, 0.5), new DLinear(0.3, 0.8)), null), "trappedTribe", false);
        ...
        PBECRegistry.register(new PBECBuffEntities(new ILinear(20 * 3, 20 * 6), new IConstant(1), new DLinear(8.0, 25.0), 0.95f, Collections.singletonList(new WeightedPotion(100, Effects.MOVEMENT_SLOWDOWN, 4, 8, 20 * 6, 20 * 20))), "frozenInPlace", false);
        ...
        PBECRegistry.register(new PBECMulti(new PBECDome(new ILinear(60, 200), new DLinear(10.0, 30.0), Collections.singletonList(new WeightedBlock(100, Blocks.GLASS)), Blocks.WATER), 0, new PBECSpawnEntities(new ILinear(60, 100), new ILinear(4, 20), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), PandorasBoxHelper.waterCreatures), 100), "aquarium", false);
        PBECRegistry.register(new PBECMulti(new PBECDome(new ILinear(60, 200), new DLinear(10.0, 30.0), Collections.singletonList(new WeightedBlock(100, Blocks.GLASS)), Blocks.WATER), 0, new PBECSpawnEntities(new ILinear(60, 100), new ILinear(1, 10), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), PandorasBoxHelper.waterMobs), 100), "aquaridoom", false);
        ...
        PBECWorldSnake doubleCaveSnake = new PBECWorldSnake(new ILinear(160, 600), new DLinear(5.0, 20.0), new DLinear(0.1, 0.5), new DLinear(1.0, 3.0), Collections.singletonList(new WeightedBlock(100, Blocks.AIR)));
        ...
        PBECRegistry.register(new PBECCover(new DLinear(10.0, 15.0), new ZConstant(false), Collections.singletonList(new WeightedBlock(100, Blocks.AIR))), "makeThin", false);
        ...
        PBECRegistry.register(new PBECSpawnEnchantedItems(new ILinear(1, 4), new ILinear(0, 30), new IExp(1, 30, 10.0), Collections.singletonList(new RandomizedItemStack(Items.ENCHANTED_BOOK, 1, 1, 100)), new ZChance(0.1)), "enchantedBook", true);
        ...
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(10, 110), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), Collections.singletonList(new WeightedEntity(100, "pbspecial_XP", 1, 1))), "experience", true);
        ...
        PBECRegistry.register(new PBECGenTreesOdd(new DLinear(10.0, 80.0), new DLinear(1.0f / (8.0f * 8.0f), 1.0f / (3.0f * 3.0f)), new ZConstant(true), new IFlags(1, 0, 0.7), PandorasBoxHelper.blocks, PandorasBoxHelper.blocks), "oddJungle", true);
        ...
        PBECRegistry.register(new PBECMulti(new PBECConvertToHeavenly(new DLinear(20.0, 80.0)), 0, new PBECRandomShapes(new DLinear(20.0, 80.0), new DLinear(2, 5), new ILinear(8, 10), Collections.singletonList(new WeightedBlock(1, Blocks.COBWEB)), new ZConstant(true)), 0), "heavenly", true);
        ...
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(100, 200), new ILinear(10, 30), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), Collections.singletonList(new WeightedEntity(100, "pbspecial_firework", 1, 1)), new ValueThrow(new DLinear(0.02, 0.06), new DConstant(0.01)), new ValueSpawn(new DLinear(2.0, 20.0), new DConstant(0.0))), "newYear", true);
        ...
        PBECRegistry.register(new PBECMulti(new PBECDome(new ILinear(60, 200), new DLinear(10.0, 30.0), Collections.singletonList(new WeightedBlock(100, Blocks.GLASS)), null), 0, new PBECSpawnEntities(new ILinear(60, 100), new ILinear(4, 20), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), PandorasBoxHelper.creatures), 0), "terrarium", true);
