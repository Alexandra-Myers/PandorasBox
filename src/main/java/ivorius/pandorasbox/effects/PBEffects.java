...
//        PBECRegistry.register(new PBECRuinedPortal(new ILinear(5, 15), new ILinear(5, 10), new ILinear(5, 15), new ILinear(2, 5), blockArrayList, loot, Direction.Axis.Z), "gateway_to_hell_z");
        ...
        PBECRegistry.register(new PBECMulti(new PBECExplosion(new ILinear(80, 100), new DConstant(10.0), new ZConstant(true), Level.ExplosionInteraction.BLOCK), 0, new PBECConvertToLifeless(new DGaussian(20.0, 40.0)), 100, new PBECSpawnEntities(new ILinear(20, 100), new ILinear(4, 20), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), PandorasBoxHelper.mobs), 100), "apocalyptic_boom");
