...
public class PBEffects {
    public static void registerEffectCreators() {
        ...
        PBECRegistry.register(new PBECReplace(new DLinear(40.0, 120.0), new Block[]{Blocks.WATER, Blocks.LAVA}, Collections.singletonList(new WeightedBlock(100, Blocks.AIR)), new ZConstant(false)), "dryness");
...
//        PBECRegistry.register(new PBECMulti(new PBECRuinedPortal(new ILinear(5, 15), new ILinear(5, 10), new ILinear(2, 5), blockArray, loot), 80, new PBECConvertToNether(new DLinear(20.0, 40.0), new DGaussian(0.01, 0.15), "wastes"), 30, new PBECPool(new DLinear(5.0, 10.0), Blocks.LAVA, Collections.singletonList(new WeightedBlock(1, Blocks.AIR))), 0), "gateway_to_hell");
        ...
        PBECRegistry.register(new PBECBuffEntities(new ILinear(20 * 3, 20 * 6), new IConstant(1), new DLinear(8.0, 25.0), 0.95f, Collections.singletonList(new WeightedPotion(100, Effects.MOVEMENT_SLOWDOWN, 4, 8, 20 * 6, 20 * 20))), "frozen_in_place");
        ...
        PBECRegistry.register(new PBECMulti(new PBECDome(new ILinear(60, 200), new DLinear(10.0, 30.0), Collections.singletonList(new WeightedBlock(100, Blocks.GLASS)), Blocks.WATER), 0, new PBECSpawnEntities(new ILinear(60, 100), new ILinear(4, 20), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), PandorasBoxHelper.waterCreatures), 100), "aquarium");
        ...
        PBECRegistry.register(new PBECCover(new DLinear(10.0, 15.0), new ZConstant(false), Collections.singletonList(new WeightedBlock(100, Blocks.AIR))), "make_thin");
        ...
        PBECRegistry.register(new PBECExplosion(new ILinear(50, 120), new DGaussian(2.0, 8.0), new ZChance(0.3), Explosion.Mode.BREAK), "thing_go_boom");
        PBECRegistry.register(new PBECMulti(new PBECExplosion(new ILinear(80, 100), new DConstant(15.0), new ZConstant(true), Explosion.Mode.DESTROY), 0, new PBECConvertToLifeless(new DGaussian(20.0, 40.0)), 100, new PBECSpawnEntities(new ILinear(20, 100), new ILinear(4, 20), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), PandorasBoxHelper.mobs), 100), "apocalyptic_boom");
        ...
        PBECRegistry.register(new PBECSpawnEnchantedItems(new ILinear(1, 4), new ILinear(0, 30), new IExp(1, 30, 10.0), Collections.singletonList(new RandomizedItemStack(Items.ENCHANTED_BOOK, 1, 1, 100)), new ZChance(0.1)), "enchanted_book");
        ...
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(10, 110), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), Collections.singletonList(new WeightedEntity(100, "pbspecial_experience", 1, 1))), "experience");
        ...
        PBECRegistry.register(new PBECGenTreesOdd(new DLinear(10.0, 80.0), new DLinear(1.0f / (8.0f * 8.0f), 1.0f / (3.0f * 3.0f)), new ZConstant(true), new IFlags(1, 0, 0.7), PandorasBoxHelper.blocks, PandorasBoxHelper.blocks), "odd_jungle");
        ...
        PBECRegistry.register(new PBECMulti(new PBECConvertToHeavenly(new DLinear(20.0, 80.0)), 0, new PBECRandomShapes(new DLinear(20.0, 80.0), new DLinear(2, 5), new ILinear(8, 10), Collections.singletonList(new WeightedBlock(1, Blocks.COBWEB)), new ZConstant(true)), 0), "heavenly");
        ...
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(100, 200), new ILinear(10, 30), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), Collections.singletonList(new WeightedEntity(100, "pbspecial_fireworks", 1, 1)), new ValueThrow(new DLinear(0.02, 0.06), new DConstant(0.01)), new ValueSpawn(new DLinear(2.0, 20.0), new DConstant(0.0))), "new_year");
        ...
        PBECRegistry.register(new PBECMulti(new PBECDome(new ILinear(60, 200), new DLinear(10.0, 30.0), Collections.singletonList(new WeightedBlock(100, Blocks.GLASS)), null), 0, new PBECSpawnEntities(new ILinear(60, 100), new ILinear(4, 20), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), PandorasBoxHelper.creatures), 0), "terrarium");
