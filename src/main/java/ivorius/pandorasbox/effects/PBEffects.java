...
public class PBEffects {
    ...
    public static void registerEffectCreators() {
        ...
        PBECRegistry.register(new PBECMeltdown(new DLinear(100.0, 175.0), new ILinear(750, 1250)), "rage_of_zeus");

        MELTDOWN_CREATORS = new PBEffectCreator[] {
                new PBECSpawnLightning(new ILinear(80, 150), new ILinear(10, 48), new DLinear(10.0, 30.0))
        };

        addAllToMeltdown(new PBECSpawnBlocks(new ILinear(10, 40), new ILinear(3, 5), new ZConstant(true), PandorasBoxHelper.blocks, null, PBECSpawnBlocks.defaultShowerSpawn()),
                new PBECSpawnBlocks(new ILinear(10, 25), new ILinear(3, 5), new ZConstant(true), PandorasBoxHelper.heavyBlocks, null, PBECSpawnBlocks.defaultShowerSpawn()),
                new PBECSpawnBlocks(new ILinear(6, 20), new ILinear(2, 5), new ZConstant(true), PandorasBoxHelper.blocks, null, new ValueSpawn(new DConstant(0.0), new DConstant(25.0))),
                ...
                new PBECMulti(new PBECSetTime(new ILinear(10, 20), new ILinear(12000, 24000 * 5), new ZConstant(true)), 0, new PBECSetWeather(new IWeighted(0, 50, 1, 15, 2, 35), new ILinear(100, 12000), new ILinear(10, 15)), 0),
                ...
                new PBECMulti(new PBECSpawnEnchantedItems(new IConstant(1), new ILinear(2, 15), new IExp(3, 30, 10.0), PandorasBoxHelper.enchantableArmorList, new ZChance(0.8), new ZConstant(true)), 0, new PBECSpawnEnchantedItems(new IConstant(1), new ILinear(2, 15), new IExp(3, 30, 10.0), PandorasBoxHelper.enchantableToolList, new ZChance(0.8), new ZConstant(true)), 0),
                ...
                new PBECSpawnEntities(new ILinear(10, 100), new ILinear(10, 30), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(true), List.of(new WeightedEntity(100, "pbspecial_fireworks", 1, 1)), new ValueThrow(new DLinear(0.02, 0.06), new DConstant(0.01)), new ValueSpawn(new DLinear(2.0, 20.0), new DConstant(0.0))),
                ...
                new PBECMulti(new PBECConvertToHomo(new DLinear(10.0, 15.0)), 10, new PBECSpawnArmy(new ILinear(1, 4), new IConstant(0), new ZConstant(true), PandorasBoxHelper.creatures), 0),
                new PBECMulti(new PBECConvertToIce(new DLinear(10.0, 15.0)), 20, new PBECDome(new ILinear(5, 10), new DGaussian(10.0, 15.0), Arrays.asList(new WeightedBlock(100, Blocks.PACKED_ICE), new WeightedBlock(80, Blocks.ICE), new WeightedBlock(50, Blocks.BLUE_ICE)), Blocks.WATER), 0),
                new PBECLavaCage(new DGaussian(10.0, 20.0), Blocks.LAVA, null, Collections.singletonList(new WeightedBlock(100, Blocks.NETHER_BRICK_WALL)), Collections.singletonList(new WeightedBlock(100, Blocks.CRYING_OBSIDIAN))),
                ...
                new PBECMulti(new PBECConvertToHeavenly(new DLinear(10.0, 15.0)), 0, new PBECSpawnItemSet(new ILinear(1, 5), new ZConstant(true), PandorasBoxHelper.equipmentSets), 0, new PBECBombpack(new DLinear(10.0, 25.0), new ILinear(15, 100)), 0),
                ...
                new PBECMulti(new PBECConvertToMushroom(new DLinear(10.0, 20.0)), 0, new PBECSpawnEntities(new ILinear(10, 50), new ILinear(3, 10), new ILinear(2, 5), new IConstant(0), new IConstant(0), new ILinear(0, 1), new ZConstant(true), PandorasBoxHelper.creatures), 10),
        ...
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(4, 20), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(false), PandorasBoxHelper.mobs), "mobs");
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(2, 6), new ILinear(2, 5), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(false), PandorasBoxHelper.mobs), "mob_towers");
        PBECRegistry.register(new PBECSpawnBlocks(new ILinear(10, 30), new ILinear(0, 10), new ZConstant(false), PandorasBoxHelper.heavyBlocks, null, PBECSpawnBlocks.defaultShowerSpawn()), "megaton");
        PBECRegistry.register(new PBECSpawnBlocks(new ILinear(30, 100), new ILinear(0, 10), new ZConstant(false), PandorasBoxHelper.blocks, null, PBECSpawnBlocks.defaultShowerSpawn()), "block_grave");
        PBECRegistry.register(new PBECSpawnBlocks(new ILinear(30, 100), new ILinear(0, 10), new ZConstant(false), PandorasBoxHelper.blocks), "block_shower");
        ...
        PBECRegistry.register(new PBECSpawnTNT(new ILinear(20, 100), new ILinear(5, 50), new ILinear(20, 1000), new ZConstant(false), new ValueSpawn(new DLinear(5.0, 50.0), new DConstant(0.0)), new ValueThrow(new DLinear(0.2, 2.0), new DLinear(0.5, 5.0))), "tntsplosion");
        PBECRegistry.register(new PBECMulti(new PBECSpawnManySameItems(new ILinear(10, 30), new ZConstant(false), PandorasBoxHelper.blocksAndItems), 0, new PBECSpawnTNT(new ILinear(20, 60), new ILinear(1, 10), new ILinear(20, 60), new ZConstant(false), new ValueSpawn(new DLinear(3.0, 10.0), new DConstant(0.0)), new ValueThrow(new DLinear(0.2, 0.5), new DLinear(0.3, 0.5))), 60), "dirty_trick");
        ...
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(20, 200), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(false), List.of(new WeightedEntity(100, "arrow", 1, 1)), new ValueThrow(new DLinear(0.05, 0.5), new DLinear(0.3, 0.8)), null), "trapped_tribe");
        ...
        PBECRegistry.register(new PBECMulti(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(4, 20), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(false), PandorasBoxHelper.mobs), 0, new PBECBuffEntities(new ILinear(60, 200), new IConstant(1), new DLinear(10.0, 40.0), 0.15f, List.of(new WeightedPotion(100, MobEffects.BLINDNESS, 1, 1, 20 * 40, 20 * 200))), 0), "pitch_black");
        ...
        PBECRegistry.register(new PBECMulti(new PBECSetTime(new ILinear(60, 200), new ILinear(12000, 24000 * 5), new ZConstant(true)), 0, new PBECSetWeather(new IWeighted(0, 50, 1, 35, 2, 15), new ILinear(100, 12000), new ILinear(10, 120)), 0), "time_lord");
        PBECRegistry.register(new PBECSpawnExploMobs(new ILinear(20, 60), new ILinear(8, 16), new ILinear(60, 200), new IWeighted(0, 100, 2, 100, 3, 100), new ZConstant(false), PandorasBoxHelper.creatures), "explocreatures");
        PBECRegistry.register(new PBECSpawnExploMobs(new ILinear(20, 60), new ILinear(8, 16), new ILinear(60, 200), new IConstant(0), new ZConstant(false), PandorasBoxHelper.mobs), "explomobs");
        PBECRegistry.register(new PBECMulti(new PBECDome(new ILinear(60, 200), new DLinear(10.0, 30.0), List.of(new WeightedBlock(100, Blocks.GLASS)), Blocks.WATER), 0, new PBECSpawnEntities(new ILinear(60, 100), new ILinear(4, 20), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(false), PandorasBoxHelper.waterCreatures), 100), "aquarium");
        PBECRegistry.register(new PBECMulti(new PBECDome(new ILinear(60, 200), new DLinear(10.0, 30.0), List.of(new WeightedBlock(100, Blocks.GLASS)), Blocks.WATER), 0, new PBECSpawnEntities(new ILinear(60, 100), new ILinear(1, 10), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(false), PandorasBoxHelper.waterMobs), 100), "aquaridoom");
        ...
        PBECRegistry.register(new PBECSpawnArmy(new ILinear(1, 3), new ILinear(0, 5), new ZConstant(false), Arrays.asList(new WeightedEntity(100, "zombie", 5, 10), new WeightedEntity(80, "skeleton", 4, 7), new WeightedEntity(40, "wither_skeleton", 5, 10))), "armored_army");
        PBECRegistry.register(new PBECSpawnArmy(new ILinear(1, 3), new IConstant(0), new ZConstant(false), PandorasBoxHelper.mobs), "army");
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 40), new IWeighted(1, 100, 2, 20, 3, 5), new IConstant(1), new ILinear(2, 6), new ILinear(2, 10), new IConstant(1), new ZConstant(false), PandorasBoxHelper.mobs), "boss");
        ...
        PBECRegistry.register(new PBECMulti(new PBECExplosion(new ILinear(80, 100), new DConstant(15.0), new ZConstant(true), Level.ExplosionInteraction.BLOCK), 0, new PBECConvertToLifeless(new DGaussian(20.0, 40.0)), 100, new PBECSpawnEntities(new ILinear(20, 100), new ILinear(4, 20), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(false), PandorasBoxHelper.mobs), 100), "apocalyptic_boom");
        PBECRegistry.register(new PBECSpawnBlocks(new ILinear(50, 120), new ILinear(0, 2), new ZConstant(false), Arrays.asList(new WeightedBlock(1, Blocks.TNT), new WeightedBlock(1, Blocks.REDSTONE_BLOCK)), null, new ValueSpawn(new DLinear(5.0, 10.0), new DConstant(150.0))).setShuffleBlocks(false), "danger_call");

        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(4, 20), new IConstant(1), new IWeighted(0, 100, 2, 50, 3, 30), new IConstant(0), new IConstant(0), new ZConstant(false), PandorasBoxHelper.creatures), "animals");
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(2, 6), new ILinear(2, 5), new IWeighted(0, 100, 2, 35, 3, 20), new IConstant(0), new IConstant(0), new ZConstant(false), PandorasBoxHelper.creatures), "animal_towers");
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(1, 8), new IConstant(1), new IWeighted(0, 50, 2, 100, 3, 20), new IConstant(0), new IConstant(0), new ZConstant(false), PandorasBoxHelper.tameableCreatures), "tamer");
        PBECRegistry.register(new PBECSpawnItems(new ILinear(1, 5), new ILinear(0, 30), PandorasBoxHelper.blocksAndItems, new ZConstant(false)), "items");
        PBECRegistry.register(new PBECSpawnItems(new ILinear(1, 3), new ILinear(0, 30), PandorasBoxHelper.items, new ZConstant(true), new ZConstant(false)), "is_this_edible");
        PBECRegistry.register(new PBECSpawnEnchantedItems(new ILinear(1, 2), new ILinear(0, 30), new IExp(1, 30, 10.0), PandorasBoxHelper.enchantableArmorList, new ZChance(0.7), new ZConstant(false)), "epic_armor");
        PBECRegistry.register(new PBECSpawnEnchantedItems(new ILinear(1, 2), new ILinear(0, 30), new IExp(1, 30, 10.0), PandorasBoxHelper.enchantableToolList, new ZChance(0.7), new ZConstant(false)), "epic_tool");
        PBECRegistry.register(new PBECSpawnEnchantedItems(new ILinear(1, 2), new ILinear(0, 30), new IExp(1, 30, 10.0), PandorasBoxHelper.items, new ZChance(0.7), new ZConstant(false)), "epic_thing");
        PBECRegistry.register(new PBECSpawnEnchantedItems(new ILinear(1, 4), new ILinear(0, 30), new IExp(1, 30, 10.0), List.of(new RandomizedItemStack(Items.ENCHANTED_BOOK, 1, 1, 100)), new ZChance(0.1), new ZConstant(false)), "enchanted_book");
        PBECRegistry.register(new PBECSpawnManySameItems(new ILinear(0, 30), new ZConstant(false), PandorasBoxHelper.blocksAndItems), "resources");
        PBECRegistry.register(new PBECSpawnItemSet(new ILinear(0, 30), new ZConstant(false), PandorasBoxHelper.equipmentSets), "equipment_set");
        PBECRegistry.register(new PBECSpawnManySameItems(new ILinear(0, 30), new ZConstant(false), PandorasBoxHelper.blocksAndItems, null, PBECSpawnItems.defaultShowerSpawn()), "item_rain");
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(10, 30), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(false), PandorasBoxHelper.creatures, null, new ValueSpawn(new DLinear(5.0, 20.0), new DConstant(150.0))), "dead_creatures");
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(10, 30), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(false), PandorasBoxHelper.landMobs, null, new ValueSpawn(new DLinear(5.0, 20.0), new DConstant(150.0))), "dead_mobs");
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(20, 100), new ILinear(10, 110), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(false), List.of(new WeightedEntity(100, "pbspecial_experience", 1, 1))), "experience");
        ...
        PBECRegistry.register(new PBECSpawnEntities(new ILinear(100, 200), new ILinear(10, 30), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(false), List.of(new WeightedEntity(100, "pbspecial_fireworks", 1, 1)), new ValueThrow(new DLinear(0.02, 0.06), new DConstant(0.01)), new ValueSpawn(new DLinear(2.0, 20.0), new DConstant(0.0))), "new_year");
        PBECRegistry.register(new PBECSpawnBlocks(new ILinear(6, 20), new ILinear(5, 20), new ZConstant(false), PandorasBoxHelper.blocks, null, new ValueSpawn(new DConstant(0.0), new DConstant(25.0))), "block_tower");
        PBECRegistry.register(new PBECMulti(new PBECDome(new ILinear(60, 200), new DLinear(10.0, 30.0), List.of(new WeightedBlock(100, Blocks.GLASS)), null), 0, new PBECSpawnEntities(new ILinear(60, 100), new ILinear(4, 20), new IConstant(1), new IConstant(0), new IConstant(0), new IConstant(0), new ZConstant(false), PandorasBoxHelper.creatures), 0), "terrarium");
        PBECRegistry.register(new PBECSpawnArmy(new ILinear(1, 3), new IConstant(0), new ZConstant(false), PandorasBoxHelper.creatures), "animal_farm");
    }
