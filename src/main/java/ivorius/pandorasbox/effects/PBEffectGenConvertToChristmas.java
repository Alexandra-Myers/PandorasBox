                ...
                if (isBlockAnyOf(block, Blocks.WATER)) {
                    ...
                    if (world.loadedAndEntityCanStandOn(posBelow, entity)) {
                        if (random.nextInt(100) == 0) {
                            ...
                            ChestTileEntity chestTileEntity = (ChestTileEntity) world.getBlockEntity(pos);
                            ...
                            if (chestTileEntity != null) {
                                ...
                                chestTileEntity.setItem(world.random.nextInt(chestTileEntity.getContainerSize()), stack);
                            }
