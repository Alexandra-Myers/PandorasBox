...
public class PBEffectGenConvertToHeavenly extends PBEffectGenerate {
    ...
    public void generateOnBlock(World world, PandorasBoxEntity entity, Vec3d effectCenter, Random random, int pass, BlockPos pos, double range) {
        ...
        if (pass == 0) {
            ...
            solid.addAll(Blocks.STONE, Blocks.ANDESITE, Blocks.DIORITE, Blocks.GRANITE, Blocks.SANDSTONE, Blocks.RED_SANDSTONE, Blocks.END_STONE, Blocks.NETHERRACK, Blocks.CRIMSON_NYLIUM, Blocks.WARPED_NYLIUM, Blocks.SOUL_SAND, Blocks.SOUL_SOIL, Blocks.SAND, Blocks.RED_SAND, Blocks.DIRT, Blocks.GRASS_BLOCK);
            ...
            if (isBlockAnyOf(block, blocks)) {
                ...
                if (world.getBlockState(pos.above()).getBlock() == Blocks.AIR) {
                    if (!world.isClientSide && world.random.nextInt(6 * 6) == 0) {
                    ...
                    } else if (!world.isClientSide && world.random.nextInt(6 * 6) == 0) {
                    ...
                    } else if (!world.isClientSide && world.random.nextInt(2 * 2) == 0) {
                        setBlockSafe(world, pos, Blocks.GLASS.defaultBlockState());
                    } else if (!world.isClientSide && world.random.nextInt(8 * 8) == 0) {
                        setBlockSafe(world, pos, Blocks.GLASS.defaultBlockState());
