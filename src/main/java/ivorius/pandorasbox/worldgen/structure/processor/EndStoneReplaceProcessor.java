...
public class EndStoneReplaceProcessor extends StructureProcessor {
	...
	private final Map<Block, Block> replacements = Util.make(Maps.newHashMap(), hashMap -> {
		...
		hashMap.put(Blocks.COBBLESTONE_STAIRS, BlockInit.END_STONE_STAIRS.get());
		hashMap.put(Blocks.MOSSY_COBBLESTONE_STAIRS, BlockInit.END_STONE_STAIRS.get());
		hashMap.put(Blocks.STONE_STAIRS, BlockInit.END_STONE_STAIRS.get());
		...
		hashMap.put(Blocks.COBBLESTONE_SLAB, BlockInit.END_STONE_SLAB.get());
		hashMap.put(Blocks.MOSSY_COBBLESTONE_SLAB, BlockInit.END_STONE_SLAB.get());
		hashMap.put(Blocks.SMOOTH_STONE_SLAB, BlockInit.END_STONE_SLAB.get());
		hashMap.put(Blocks.STONE_SLAB, BlockInit.END_STONE_SLAB.get());
		...
		hashMap.put(Blocks.COBBLESTONE_WALL, BlockInit.END_STONE_WALL.get());
		hashMap.put(Blocks.MOSSY_COBBLESTONE_WALL, BlockInit.END_STONE_WALL.get());
		hashMap.put(Blocks.CHISELED_STONE_BRICKS, BlockInit.CHISELED_END_STONE_BRICKS.get());
		hashMap.put(Blocks.CRACKED_STONE_BRICKS, Blocks.END_STONE_BRICKS);
        hashMap.put(Blocks.INFESTED_COBBLESTONE, BlockInit.INFESTED_END_STONE.get());
        hashMap.put(Blocks.INFESTED_STONE, BlockInit.INFESTED_END_STONE.get());
        hashMap.put(Blocks.INFESTED_STONE_BRICKS, BlockInit.INFESTED_END_STONE_BRICKS.get());
        hashMap.put(Blocks.INFESTED_CRACKED_STONE_BRICKS, BlockInit.INFESTED_END_STONE_BRICKS.get());
        hashMap.put(Blocks.INFESTED_MOSSY_STONE_BRICKS, BlockInit.INFESTED_END_STONE_BRICKS.get());
        hashMap.put(Blocks.INFESTED_CHISELED_STONE_BRICKS, BlockInit.INFESTED_CHISELED_END_STONE_BRICKS.get());
	});
	...
	protected StructureProcessorType<?> getType() {
		return StructureInit.END_STONE_REPLACE.get();
	}
}
