...
public class PandoraShrineStructure extends Structure {
    ...
    public static final Codec<PandoraShrineStructure> CODEC = RecordCodecBuilder.create(
    ...
    private static int findSuitableY(
        ...
        int lowestAcceptedHeight = levelHeightAccessor.getMinBuildHeight() + 15;
    ...
    public StructureType<?> type() {
        return StructureInit.PANDORA_SHRINE.get();
    }
}
