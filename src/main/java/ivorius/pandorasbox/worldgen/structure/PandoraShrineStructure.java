...
import ivorius.pandorasbox.weighted.WeightedIdentifier;
...
public class PandoraShrineStructure extends Structure {
    private final List<WeightedIdentifier> templates;
    ...
    public static final MapCodec<PandoraShrineStructure> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(settingsCodec(instance),
                            WeightedIdentifier.CODEC.listOf().fieldOf("templates").forGetter(arg -> arg.templates),
    ...
    public PandoraShrineStructure(Structure.StructureSettings arg, List<WeightedIdentifier> templates, ZValue overgrown, boolean replaceWithEndStone, Optional<Integer> aboveHeight) {
        super(arg);
    ...
    public Optional<GenerationStub> findGenerationPoint(Structure.GenerationContext ctx) {
        ...
        Identifier possibleStructures = WeightedSelector.selectItem(random, templates).identifier();
