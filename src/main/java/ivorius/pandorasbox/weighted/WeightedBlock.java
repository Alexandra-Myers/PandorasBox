...
public record WeightedBlock(double weight, Holder<Block> block) implements WeightedSelector.Item {
    ...
    public static final Codec<EitherArrayList<WeightedBlock, WeightedTag<Block>>> CODEC = Codec.either(BLOCK_CODEC, WeightedTag.codec(Registries.BLOCK)).listOf().xmap(EitherArrayList::new, Function.identity());
