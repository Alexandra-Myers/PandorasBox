...
public record WeightedEntity(String entityID, WeightedWithRandomCount count) implements WeightedSelector.Item {
    ...
    public static final Codec<String> ID_CODEC = validate(ResourceLocation.CODEC, resourceLocation -> BuiltInRegistries.ENTITY_TYPE.containsKey(resourceLocation) || Arrays.asList(PB_SPECIAL_LOCS).contains(resourceLocation.getPath()) ? DataResult.success(resourceLocation) : DataResult.error(() -> "Unknown registry key in " + Registries.ENTITY_TYPE + " found, and was not a pbspecial entity! Input: " + resourceLocation)).xmap(ResourceLocation::toString, ResourceLocation::tryParse);
    ...
    public static final Codec<WeightedEntity> NO_SPECIAL_CODEC = RecordCodecBuilder.create(instance ->
            instance.group(validate(ResourceLocation.CODEC, resourceLocation -> BuiltInRegistries.ENTITY_TYPE.containsKey(resourceLocation) ? DataResult.success(resourceLocation) : DataResult.error(() -> "Unknown registry key in " + Registries.ENTITY_TYPE + ": " + resourceLocation)).xmap(ResourceLocation::toString, ResourceLocation::tryParse).fieldOf("entity").forGetter(WeightedEntity::entityID),
                            WeightedWithRandomCount.CODEC_FORCE.forGetter(WeightedEntity::count))
                    .apply(instance, WeightedEntity::new));
